...
#CRED_NAME=<your dockerhub username>
#CRED_PASS=<your dockerhub token/password>
...
#/vagrant/add-jenkins-credentials.sh docker-hub $CRED_NAME $CRED_PASS

echo "* Add slave node ..."
/vagrant/jenkins/add-jenkins-slave.sh docker.homework.lab vagrant

echo "* Add jobs"
/vagrant/jenkins/add-jenkins-jobs.sh
