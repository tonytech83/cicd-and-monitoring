...
- Try to implement as many of the remaining tests as possible to the respective **Gitea** or **Jenkins** pipeline

- Try to move from **monorepo** to **polyrepo** model
  ...
  - there is **[no need]{.underline}** to have any triggering or connection between the individual repositories
...
2. [Task 2](./task1/task2.md)
3. [Task 3](./task1/task3.md)